      ...
      Card(
        ...
        Row(
          ...
          Column(modifier = Modifier.weight(1f)) {
            ...
            Text(
              text = stringResource(R.string.create_blank_playlist_summary),
      ...
      Card(
        ...
        Row(
          ...
          Column(modifier = Modifier.weight(1f)) {
            ...
            Text(
              text = stringResource(R.string.import_playlist_from_web_url),
              style = MaterialTheme.typography.bodySmall,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
          }
                ...
                if (playlistName.isNotBlank()) {
                  coroutineScope.launch {
                    try {
                      ...
                      android.widget.Toast.makeText(
                        context,
                        context.getString(R.string.playlist_create_error, e.message ?: ""),
